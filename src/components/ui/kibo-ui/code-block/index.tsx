...
export const CodeBlock = ({
  ...
  return (
    <CodeBlockContext.Provider value={{ value, onValueChange, data }}>
      <div
        className={tw('size-full overflow-hidden rounded-md border', className)}
        {...props}
      />
...
export const CodeBlockFiles = ({
  ...
  return (
    <div
      className={tw('flex grow flex-row items-center gap-2', className)}
      {...props}
    >
      {data.map(children)}
    </div>
